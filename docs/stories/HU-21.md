...
- [x] **Crear `RepsRangeParser`** (AC: CA-21.08, CA-21.09, CA-21.10, CA-21.15, CA-21.16)
...
- [x] **Crear `LoadDisplayMapper`** (AC: CA-21.01, CA-21.04, CA-21.05, CA-21.07)
...
- [x] **Crear `RepsDisplayMapper`** (AC: CA-21.04)
...
- [x] **Crear modelo `SessionPreviewExercise`** (AC: CA-21.01)
...
- [x] **Crear DTO `SessionPreviewExerciseDto`** (AC: CA-21.01)
...
- [x] **Crear query `getPreviewByModuleVersionId()`** (AC: CA-21.01, CA-21.04, CA-21.07)
...
- [x] **Agregar método a `SessionRepository`** (AC: CA-21.01)
...
- [x] **Implementar en `SessionRepositoryImpl`** (AC: CA-21.01)
...
- [x] **Crear `GetSessionPreviewUseCase`** (AC: CA-21.01)
...
- [x] **Crear `SessionPreviewUiState`** (AC: CA-21.01, CA-21.06)
...
- [x] **Crear `SessionPreviewViewModel`** (AC: CA-21.01, CA-21.02, CA-21.04, CA-21.05, CA-21.06, CA-21.07)
...
- [x] **Crear `SessionPreviewScreen`** (AC: CA-21.01, CA-21.02, CA-21.03, CA-21.04, CA-21.05)
  ...
  - [x] Badge "Fuera del gym" para ejercicios bodyweight del módulo A (CA-21.05)
  - [x] Botón CTA "Iniciar Sesión" al final

#### 📦 UI — Navegación

- [x] **Agregar ruta `SESSION_PREVIEW`** (AC: CA-21.02, CA-21.03)
...
- [x] **Agregar composable en `TensionNavHost`** (AC: CA-21.02, CA-21.03)
...
- [x] **Modificar `HomeScreen`** (AC: CA-21.01, CA-21.02, CA-21.06)
...
- [x] **Agregar strings para preview** (AC: CA-21.01)
...
- [x] **Crear enum `TimerState`** (AC: CA-21.08)
  - [x] Valores: `IDLE`, `RUNNING`, `STOPPED` - Archivo: `ui/session/RegisterSetUiState.kt`

- [x] **Modificar `RegisterSetUiState`** (AC: CA-21.08, CA-21.10, CA-21.11, CA-21.12)
...
- [x] **Modificar `RegisterSetViewModel`** (AC: CA-21.08, CA-21.09, CA-21.10, CA-21.11, CA-21.12, CA-21.16, CA-21.17, CA-21.19)
  ...
  - [x] Si `info.isIsometric && !range.isSeconds` → fallback `showChronometer=true`, `minSeconds=30`, `maxSeconds=60` (CA-21.16)
  ...
  - [x] Auto-stop: cuando `timerSeconds >= maxSeconds` → llamar `onStopTimer()` automáticamente (CA-21.09)
...
- [x] **Crear `IsometricChronometer`** (AC: CA-21.08, CA-21.09, CA-21.10, CA-21.11, CA-21.13, CA-21.14)
  ...
  - [x] Indicación visual si se detiene antes del mínimo (CA-21.11): texto "Tiempo por debajo del rango prescrito" en color `error`

- [x] **Modificar `RegisterSetScreen`** (AC: CA-21.08, CA-21.14, CA-21.18)
...
- [x] **Agregar strings para cronómetro** (AC: CA-21.08, CA-21.13)
...
3. **Desarrollador:** ✅ Completado. Implementación de las 6 fases de tareas definidas en el refinamiento técnico. Ver Dev Agent Record más abajo.
...
- **Fase 6:** TimerState enum + 5 campos cronómetro en RegisterSetUiState + isConfirmEnabled condicional. Timer con SystemClock.elapsedRealtime() resiliente a background, auto-stop al máximo, RepsRangeParser + fallback isométrico. IsometricChronometer composable con CircularProgressIndicator, colores semánticos (error/progressionPositive), señalización dual color+ícono+texto, 3 botones contextuales. Condicional ChromómetrovsRepsField en RegisterSetScreen.
- **Auditoría:** 108 tareas marcadas completadas en HU-21.md. Audit conformance report: 12 items PASS, 2 issues corregidos (timer precision + DTO nullability), 3 issues pre-existentes no atribuibles a HU-21.
