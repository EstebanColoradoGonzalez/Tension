...
- **Orden:** `HU-39` primero y `HU-40` inmediatamente después —orden crítico—; `HU-41` tercera; `HU-42` paralelizable tras `HU-39`; `HU-43` última, tras `HU-39` y `HU-41`. **`HU-39`, `HU-40` y `HU-41` están implementadas** (2026-09-07 las dos primeras, 2026-09-11 la tercera): el esquema es la versión 22, el respaldo la 15, la unidad de comparación del motor es el par (ejercicio, equipamiento), el catálogo tiene 33 zonas jerarquizadas sobre los mismos 14 grupos y el plan por defecto sugiere implemento en sus 35 asignaciones. `HU-43` puede arrancar: su prerrequisito —el formulario de ejercicio con equipamiento múltiple y jerarquía de zonas— está entregado.
...
| Historias en Borrador (PO) | 2 (HU-42 y HU-43 — EPIC-10, pendientes de análisis arquitectónico) |
